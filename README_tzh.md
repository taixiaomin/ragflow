...
- [docker-compose.yml](docker/docker-compose-x86.yml): 系統依賴該檔案完成啟動。
...
如需更新預設的 HTTP 服務連接埠(80), 可以在[docker-compose.yml](docker/docker-compose-x86.yml) 檔案中將配置 `80:80` 改為 `<YOUR_SERVING_PORT>:80` 。
